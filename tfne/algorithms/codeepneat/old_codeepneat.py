...
class CoDeepNEAT(BaseNeuroevolutionAlgorithm):
    ...
    def _new_old_select_modules_basic(self) -> {int: int}:
        """"""
        ...
        for spec_id, spec_avg_fitness in mod_species_avg_fitness.items():
            ...
            # TODO Comment
            if spec_size - self.mod_spec_mod_elitism <= self.mod_spec_min_offspring:
        ...
        return mod_species_offspring

    def old_evolve_population(self) -> bool:
        """"""
        #### Speciate Modules ####
        if self.mod_spec_type == 'basic':
