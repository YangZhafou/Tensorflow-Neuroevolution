...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mba_lbl_bp_graph = QtWidgets.QLabel(self.mba_widget_blueprint)
        self.mba_lbl_bp_graph.setGeometry(QtCore.QRect(0, 590, 110, 20))
        self.mba_lbl_bp_graph.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.mba_lbl_bp_graph.setObjectName("mba_lbl_bp_graph")
        ...
        self.mba_lbl_bp_graph_area = QtWidgets.QScrollArea(self.mba_widget_blueprint)
        self.mba_lbl_bp_graph_area.setGeometry(QtCore.QRect(110, 590, 350, 70))
        self.mba_lbl_bp_graph_area.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.mba_lbl_bp_graph_area.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.mba_lbl_bp_graph_area.setWidgetResizable(True)
        self.mba_lbl_bp_graph_area.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.mba_lbl_bp_graph_area.setObjectName("mba_lbl_bp_graph_area")
        self.mba_lbl_bp_graph_widget = QtWidgets.QWidget()
        self.mba_lbl_bp_graph_widget.setGeometry(QtCore.QRect(0, 0, 350, 70))
        self.mba_lbl_bp_graph_widget.setObjectName("mba_lbl_bp_graph_widget")
        self.mba_lbl_bp_graph_layout = QtWidgets.QVBoxLayout(self.mba_lbl_bp_graph_widget)
        self.mba_lbl_bp_graph_layout.setContentsMargins(0, 3, 10, 0)
        self.mba_lbl_bp_graph_layout.setObjectName("mba_lbl_bp_graph_layout")
        self.mba_lbl_bp_graph_value = QtWidgets.QLabel(self.mba_lbl_bp_graph_widget)
        self.mba_lbl_bp_graph_value.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.mba_lbl_bp_graph_value.setWordWrap(True)
        self.mba_lbl_bp_graph_value.setObjectName("mba_lbl_bp_graph_value")
        self.mba_lbl_bp_graph_layout.addWidget(self.mba_lbl_bp_graph_value)
        self.mba_lbl_bp_graph_area.setWidget(self.mba_lbl_bp_graph_widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mba_lbl_bp_graph.setText(_translate("MainWindow", "BP Graph:"))
        self.mba_lbl_bp_parent_mut_value.setText(_translate("MainWindow", "sometext"))
        self.mba_lbl_bp_optimizer_value.setText(_translate("MainWindow", "sometext"))
        self.mba_lbl_bp_graph_value.setText(_translate("MainWindow", "sometext"))
